...
= 4.3.3 =
* Fix: Input loosing focus after editing an automation rule.
...
= 4.2.7 =
* Fix: Automated emails should be scheduled after double opt-in.

= 4.2.4 =
* Add: Improved WPML and Polylang compatibility for multilingual newsletters.
