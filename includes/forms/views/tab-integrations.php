...
<?php if ( noptin_upsell_integrations() ) : ?>
	<div class="card">
		...
		<p><a href="<?php echo esc_url( noptin_get_guide_url( 'Subscription Forms', '/integrations/#connections' ) ); ?>" class="button noptin-button-standout" target="_blank"><?php esc_html_e( 'View Integrations', 'newsletter-optin-box' ); ?>&nbsp;<i class="dashicons dashicons-arrow-right-alt"></i></a></p>
	</div>
<?php else : ?>
