...
<div class="card">
	...
	<p><a href="<?php echo esc_url( noptin_get_guide_url( 'Subscription Forms', '/sending-emails/welcome-emails/' ) ); ?>" class="button noptin-button-standout" target="_blank"><?php esc_html_e( 'Learn More', 'newsletter-optin-box' ); ?>&nbsp;<i class="dashicons dashicons-arrow-right-alt"></i></a></p>
</div>
