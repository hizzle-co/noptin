<?php
/**
 * Noptin Connection Provider Remove List Action Class.
 *
 * @package Noptin\noptin.com
 * @since   1.5.1
 */
 ...
 * @ignore
 */
class Noptin_Connection_Provider_Remove_List_Action extends Noptin_Abstract_Action {
    ...
    public function get_name() {
        return sprintf(
            __( '%s List Remove', 'newsletter-optin-box' ),
            $this->provider->name
        );
    }
    ...
    public function get_description() {
        return sprintf(
            __( 'Removes the subscriber from a %s list', 'newsletter-optin-box' ),
            $this->provider->name
        );
    }
    ...
    public function get_rule_description( $rule ) {
        ...
        return sprintf(
            __( 'Remove the subscriber from the list "%s"', 'newsletter-optin-box' ),
    ...
    public function get_settings() {
        ...
        return array(
            ...
            'list'     => array(
				...
				'description' => __( 'Select the list where you want the subscriber to be removed from.', 'newsletter-optin-box' ),
            )
    ...
    /**
     * Remove the subscriber from a list.
     *
     * @since 1.5.1
