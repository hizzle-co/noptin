...
<div class="noptin-email-types">
		...
		<?php
			foreach ( noptin()->emails->automated_email_types->types as $type ) :

				if ( 0 === strpos( $type->type, 'woocommerce' ) ) {
					$woocommerce_automations[] = $type;
					continue;
				}
		...
		?>
			...
			<div class="card noptin-email-type">
				<div class="noptin-email-type-image"><?php $type->the_image(); ?></div>
		...
		<?php if ( ! defined( 'NOPTIN_WELCOME_EMAILS_FILE' ) ) : ?>
			...
			<div class="card noptin-email-type">
				...
				<div class="noptin-email-type-content">
					<h3><?php _e( 'Welcome New Subscribers', 'newsletter-optin-box' ); ?></h3>
			...
			<div class="card noptin-email-type">
				...
				<div class="noptin-email-type-content">
					<h3><?php _e( 'Welcome New Users', 'newsletter-optin-box' ); ?></h3>
					<p><?php _e( 'Welcome new users to your website, introduce yourself, etc', 'newsletter-optin-box' ); ?></p>
					<p style="color: #a00;"><em><?php _e( 'Not available in your plan', 'newsletter-optin-box' ); ?></em></p>
					<div class="noptin-email-type-action">
						<a href="https://noptin.com/product/ultimate-addons-pack?utm_medium=plugin-dashboard&utm_campaign=automated-emails&utm_source=welcome_users_email" class="button" target="_blank"><?php _e( 'Upgrade', 'newsletter-optin-box' ); ?>&nbsp;<i class="dashicons dashicons-arrow-right-alt" style="vertical-align: middle;"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="card noptin-email-type">
				...
				<div class="noptin-email-type-content">
					...
					<p><?php _e( 'Send an email to a subscriber when they are tagged or untagged.', 'newsletter-optin-box' ); ?></p>
					<p style="color: #a00;"><em><?php _e( 'Not available in your plan', 'newsletter-optin-box' ); ?></em></p>
					<div class="noptin-email-type-action">
...
<?php if ( ! empty( $woocommerce_automations ) ) : ?>
	...
	<div class="noptin-email-types">
		<?php foreach ( $woocommerce_automations as $type ) : ?>
			<div class="card noptin-email-type">
				<div class="noptin-email-type-image"><?php $type->the_image(); ?></div>
				<div class="noptin-email-type-content">
					<h3><?php echo esc_html( $type->get_name() ); ?></h3>
