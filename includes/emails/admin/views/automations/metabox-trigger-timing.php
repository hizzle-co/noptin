...
<?php if ( ! defined( 'NOPTIN_ADDONS_PACK_FILE' ) ) : ?>
	<h3><?php esc_html_e( 'Delay this email', 'newsletter-optin-box' ); ?></h3>
	<p><?php esc_html_e( 'The add-ons pack allows you to delay this email for a given number of minutes, hours, or days.', 'newsletter-optin-box' ); ?></p>
