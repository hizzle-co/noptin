...
<table class="form-table" role="presentation">
	<tbody>
		...
		<tr class="noptin-is-conditional noptin-show-if-automation-is-normal">
			...
			<td>
				<textarea id="noptin-automated-email-permission-text" name="noptin_automation[footer_text]" class="noptin-admin-field-big" placeholder="<?php echo esc_attr( get_noptin_footer_text() ); ?>" rows="4"><?php echo esc_textarea( $campaign->get( 'footer_text' ) ); ?></textarea>
			</td>
		</tr>
