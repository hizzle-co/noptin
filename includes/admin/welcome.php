<div class="noptin-welcome">
	...
	<div class="noptin-body">
		...
		<p>This update makes it possible to delete specific subscribers, set default success messages among other improvements.</p>
		<h3>Translation Ready</h3>
		<p>You can now translate any string generated by the plugin. Help us <a href="https://translate.wordpress.org/projects/wp-plugins/newsletter-optin-box/">translate the plugin into your language</a>.</p>
		<h3>ConvertKit Integration</h3>
		<p>We now have a <a href="https://noptin.com/product/convertkit/" target="_blank">ConvertKit addon</a>.</p>
		<hr/>
