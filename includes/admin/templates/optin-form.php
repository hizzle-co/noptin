	...
	<form <?php echo noptin_form_template_form_props(); ?>>
		...
		<div class="noptin-form-footer">
			<div class="noptin-form-fields">
				<div  v-for="field in fields"  :key="field.key" class="noptin-optin-field-wrapper"  :class="field.type">

					<input v-if="field.type=='email'" name='email' type="email" class="noptin-form-field" :placeholder="field.label" :required="field.require" />
					<input v-if="field.type=='first_name'" name='first_name' type="text" class="noptin-form-field" :placeholder="field.label" :required="field.require" />
					<input v-if="field.type=='last_name'" name='last_name' type="text" class="noptin-form-field" :placeholder="field.label" :required="field.require" />
					<input v-if="field.type=='name'" name='name' type="text" class="noptin-form-field" :placeholder="field.label" :required="field.require" />
