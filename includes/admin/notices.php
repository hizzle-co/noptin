...
/**
 * https://github.com/YahnisElsts/admin-notices/blob/master/AdminNotice.php
 */

	class Noptin_Notices {
	...
	if (function_exists('add_action')) {
		...
		add_action('admin_init', array( 'Noptin_Notices', '_ajaxAddDismissalHandler'), 300);
	}
