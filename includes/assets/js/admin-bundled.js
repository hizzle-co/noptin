	...
	var vm = new Vue({
		...
		watch: {
			...
			showPostTypes: function() {
				console.log(this.showPostTypes)
			}
		},
...
},{"vue-quill-editor":6,"vue-select":7,"vue-swatches":8}],5:[function(require,module,exports){
(function (Buffer){
/*!
 * Quill Editor v1.3.6
 * https://quilljs.com/
...
},{"quill":5}],7:[function(require,module,exports){
