												...
												<tr>
													<td align="center" style="border-radius: 6px;">
														<div style='text-align: left; padding: 20px;' align='left'>
															<a href="<?php echo esc_url( $cta_url ); ?>" target="_blank" style="background: #1a82e2; display: inline-block; padding: 16px 36px; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;"><?php echo $cta_text; ?></a>
														</div>
													</td>
												</tr>
											</table>
