<div class="wrap noptin-add-campaign-page" id="noptin-wrapper">
	<?php
		printf(
			...
			esc_html__( 'New Email','newsletter-optin-box' ),
			esc_url(
				add_query_arg(
					array(
						'sub_section' => false,
	...
	<form name="noptin-create-newsletter" method="post">
				...
				<div id="post-body-content">
					...
					<div id="titlediv">
						<div id="titlewrap">
							...
							<input type="text" name="email_subject" size="30" value="" placeholder="<?php esc_attr_e( "Enter your Email's Subject", 'newsletter-optin-box' ); ?>" id="title" spellcheck="true" autocomplete="off">
						</div>
					</div>
