 ...
 * @since 1.2.8
 */
abstract class Trigger extends \Hizzle\Noptin\Automation_Rules\Trigger_Action {
	...
	public function get_known_smart_tags() {
		...
		$smart_tags = array(
			...
			'user_agent'       => array(
				...
				'replacement'       => sanitize_text_field( wp_unslash( $_SERVER['HTTP_USER_AGENT'] ?? '' ) ),
				'conditional_logic' => 'string',
				'placeholder'       => sanitize_text_field( wp_unslash( $_SERVER['HTTP_USER_AGENT'] ?? '' ) ),
			),
			'referer'          => array(
	...
	public function serialize_trigger_args( $args ) {
		...
		if ( $args['subject'] instanceof \Hizzle\Noptin\Subscribers\Subscriber ) {
