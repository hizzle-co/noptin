...
namespace Hizzle\Noptin\Emails\Generate\CssToInlineStyles\Css\Rule;

use Symfony\Component\CssSelector\Node\Specificity;
use Hizzle\Noptin\Emails\Generate\CssToInlineStyles\Css\Property\Processor as PropertyProcessor;
...
class Processor {
	...
	/**
	 * @param string $to_cleanup
	 *
	 * @return string
	 */
	private function cleanup( $to_cleanup ) {
	...
	public function calculateSpecificityBasedOnASelector( $selector ) {
		...
		if ( false === $idSelectorCount || false === $classAttributesPseudoClassesSelectorCount || false === $typePseudoElementsSelectorCount ) {
